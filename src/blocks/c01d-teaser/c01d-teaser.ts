...
interface TeaserSharingTemplateArgs {
  name?: string | null;
  url?: string | null;
}

const teaserTemplateOverview = (args: TeaserSharingTemplateArgs[]) => {
  return html`
    <div
      ...
      <div class="dvag-m-c01d-teaser  " style="--gradient-color:#CCDDE4">
        ...
        <div class="dvag-m-c01d-teaser__grid-wrapper">
          <div class="dvag-m-c01d-teaser__content-wrapper">
            <h4 class="dvag-m-c01d-teaser__subheadline">${args.name}</h4>
...
export default function (block: HTMLElement) {
  ...
  cleanUpBlock(block);
  render(teaserTemplateOverview(name), block);
}
